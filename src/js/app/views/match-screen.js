        ...
        isReady: function() {
            ...
            if(this.userValidForMatch(App.player1) && this.userValidForMatch(App.player2)) {
                ...
                var moments = {
                    ...
                    3: { 'time': 85, 'action': 'Great save', 'title': '', 'description': 'Another Real free-kick, another flying save from Roman Weidenfeller! ' + this.pickRandomPlayerName(team2) + ' has his eyes on the prize this time, unleashing a dipper that forces the Dortmund keeper into a fine save again.' },
                    4: { 'time': 85, 'action': 'Yellow card', 'title': '', 'description':  this.pickRandomPlayerName(team2) + ' hacks down Santi Cazorla. Yellow card and an Arsenal free-kick 40 yards from goal...' }
                };
